...
import {Demands, formatDate, getStatusColors, getStatusLabel} from "../Utils";

function Resquest() {
    return (
        <div className=" container bg-white shadow-md rounded-md">
            ...
            {Demands.map((item,index)=>(
                        <article key={item._id}  className={`grid grid-cols-12 border-t border-gray-300 col-span-2 items-center ${index % 2 === 0? 'bg-gray-400':null}`}>
